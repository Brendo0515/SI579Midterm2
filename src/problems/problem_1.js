...
const explanation = `Celsius is not set as a state variable, therefore the code cannot detect updates when the function is run.  Celsius updates when set as a state.`;
